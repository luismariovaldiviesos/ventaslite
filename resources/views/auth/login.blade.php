            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <h1 class="text-center"><span class="brand-name"><b>Ventas</b></span></h1>
                        ...
                        <form class="text-left mt-5" action="{{ route('login') }}" method="POST">
                            ...
                            <div class="form" >
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="email" name="email" type="email" class="form-control @error('email') is-invalid @enderror" placeholder="ingrese su email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                    @error('email')
